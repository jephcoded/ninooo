    ...
    <main className="section-shell flex min-h-[calc(100vh-10rem)] items-center py-24">
      <div className="max-w-3xl space-y-6">
        ...
        <h1 className="font-display text-4xl font-semibold tracking-[-0.04em] text-white sm:text-5xl">
          Built around precision service, trusted workmanship, and modern automotive care.
        </h1>
        <p className="max-w-2xl text-base leading-8 text-slate-300">
          NINO brings together diagnostics discipline, workshop experience, and engineering-led thinking to help drivers and businesses keep their vehicles performing at the level they expect.
        </p>
