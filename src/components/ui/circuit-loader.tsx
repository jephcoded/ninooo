...
export function CircuitLoader({ compact = false }: CircuitLoaderProps) {
  return (
    <div className={`relative ${compact ? "h-56 w-56" : "h-72 w-72"}`}>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(249,115,22,0.18),transparent_26%)] blur-2xl" />

      <svg viewBox="0 0 480 300" className="absolute inset-0 h-full w-full" fill="none" aria-hidden="true">
        <rect x="170" y="105" width="140" height="90" rx="14" className="fill-[rgba(15,23,42,0.92)] stroke-[rgba(249,115,22,0.18)]" strokeWidth="1.2" />
